...
Процедура ПриЗаполненииПоставляемыхПрофилейГруппДоступа(ОписанияПрофилей, ПараметрыОбновления) Экспорт
    ...
    //ВКМ доработка Абонентское обслуживание
	//Добавление поставляемых профилей групп доступа: БухгалтерИТФирмы, КадровикРасчетчик, Менеджер и Специалист
    
    // Профиль БухгалтерИТФирмы	
	ОписаниеПрофиля = УправлениеДоступом.НовоеОписаниеПрофиляГруппДоступа();
	ОписаниеПрофиля.Имя           = "БухгалтерИТФирмы";
	ОписаниеПрофиля.Идентификатор = "0f083dbc-0bdf-44c1-84d8-ebe8d8a4699d";
	...
	| Работа с обработкой Массовое создание документов реализации,
	| Работа с отчетом Анализ выставленных актов.'");	
	ОписаниеПрофиля.Роли.Добавить("ЗапускВебКлиента");
	ОписаниеПрофиля.Роли.Добавить("ЗапускТонкогоКлиента");
	ОписаниеПрофиля.Роли.Добавить("БазовыеПраваБСП");
	ОписаниеПрофиля.Роли.Добавить("ВыводНаПринтерФайлБуферОбмена");
	...
	ОписаниеПрофиля.Идентификатор = "879f5076-0696-4828-9db0-923511a548e6";
	...
	| Работа с документом Начисление заработной платы.
	| Работа с документом Начисление фиксированных премий.
	| Работа с документом Выплата зарплаты.
	| Работа с отчетом Расход запланированных отпусков.
	| Работа с отчетом Выработка специалистов.'");
	ОписаниеПрофиля.Роли.Добавить("ЗапускВебКлиента");
	ОписаниеПрофиля.Роли.Добавить("ЗапускТонкогоКлиента");
	ОписаниеПрофиля.Роли.Добавить("БазовыеПраваБСП");
	ОписаниеПрофиля.Роли.Добавить("ВыводНаПринтерФайлБуферОбмена");
	...
	ОписаниеПрофиля = УправлениеДоступом.НовоеОписаниеПрофиляГруппДоступа();
	ОписаниеПрофиля.Имя           = "Менеджер";
	ОписаниеПрофиля.Идентификатор = "d8abd59a-0910-402b-b636-9da42543cf38";
	...
	| Работа с документом Обслуживание клиентов.'");
	ОписаниеПрофиля.Роли.Добавить("ЗапускВебКлиента");
	ОписаниеПрофиля.Роли.Добавить("ЗапускТонкогоКлиента");
	ОписаниеПрофиля.Роли.Добавить("БазовыеПраваБСП");
	ОписаниеПрофиля.Роли.Добавить("ВыводНаПринтерФайлБуферОбмена");
